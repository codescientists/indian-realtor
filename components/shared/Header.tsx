...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between py-8 px-4 md:px-14 xl:px-20 w-full sticky top-0 bg-blue-500 text-white z-50">
      ...
      <div className="hidden md:flex">
        ...
        <li>
            <Link
              href="/properties"
              className="text-slate-100 hover:text-white transition text-md"
            >
              Properties
            </Link>
          </li>
